\documentclass[main=french,a4paper]{book}
...
\begin{document}
%%%% à partir d'un modèle proposé par kira.ribeiro@universite-paris-saclay.fr %%%%
%%%% màj : 1 mars 2023 %%%%
...
\begin{center} 
\includegraphics[scale=0.6]{photo_logo/Charte_graphique_ups.png}
\end{center}
